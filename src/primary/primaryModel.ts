...
export interface PrimaryTaskProposal { projectName: string; objective: string; provider?: AgentProviderId; rationale?: string; portfolioCapability?: boolean; }
