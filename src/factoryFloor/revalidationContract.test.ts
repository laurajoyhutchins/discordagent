...
const EXPECTED_FIXTURE_DIGEST = '9e1d155cfc79f61bc373ada6a35a9157cbe557894fe58fcc7ea0ec193c9395ef';
...
describe('Discord Activity reverse revalidation contract fixture', () => {
  ...
  it('freezes the action-specific allow and deny envelopes', () => {
  ...
  it('lists the complete stable decision vocabulary without role data', () => {
